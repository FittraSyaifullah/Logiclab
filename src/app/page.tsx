...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-svh bg-white relative overflow-hidden grid-background">
      ...
      {/* Hero Section */}
        <section className="px-4 sm:px-6 pt-12 sm:pt-20 pb-5 text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center gap-2 mt-6 sm:mt-8 text-black">
            <div className="flex items-center gap-2">
              ...
              <span className="text-base sm:text-lg">Get ready to print 3D models in 6 minutes</span>
            </div>
            <div className="flex items-center gap-2">
              <Check className="h-5 w-5" />
              <span className="text-base sm:text-lg">Built for innovators</span>
            </div>
        </div>
      </section>
        ...
        <section className="px-4 sm:px-6 pt-5 pb-16 sm:pb-20 max-w-6xl mx-auto">
          <h2 className="text-2xl sm:text-4xl font-bold text-center text-gray-900 mb-8 sm:mb-16">How Buildables works</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <Card className="border-2 border-gray-100 hover:border-orange-200 transition-all duration-300 hover:scale-105 hover:shadow-lg">
              <CardContent className="p-8 text-center">
                <div className="w-full h-40 sm:h-48 bg-gray-100 rounded-lg mb-6 flex items-center justify-center overflow-hidden">
                  <Image
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Talk in plain English</h3>
            ...
            <Card className="border-2 border-gray-100 hover:border-orange-200 transition-all duration-300 hover:scale-105 hover:shadow-lg">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4">Learn and iterate</h3>
                <p className="text-black text-sm sm:text-base">
        ...
        <section className="px-4 sm:px-6 py-16 sm:py-20 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Build the future of hardware with natural language</h2>
          ...
          <Button
            onClick={handleSearchClick}
            size="lg"
            className="bg-orange-500 hover:bg-orange-600 text-white px-8 sm:px-12 py-3 sm:py-4 rounded-full text-lg sm:text-xl transition-transform duration-200 active:scale-95"
          >
            Get Started Today
          </Button>
        </section>
